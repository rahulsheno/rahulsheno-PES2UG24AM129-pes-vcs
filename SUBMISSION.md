...
```
PES_AUTHOR="Rahul Vivek Shenoy <PES2UG24AM129>"
```
...
## Phase 2: Branching and Checkout (Analysis)

### Q2.1: Implementing `pes checkout <branch>`
...
### Q2.2: Detecting "dirty working directory" conflicts
...
## Phase 3: Garbage Collection (Analysis)

### Q3.1: Finding and deleting unreachable objects
...
### Q3.2: Race condition in concurrent GC
